<%-- 
    Document   : index
    Created on : Mar 24, 2020, 10:23:36 PM
    Author     : Tacom
--%>
 	 ...
 	 <!-- /w3l-agileits -->
		<!-- //header-ends -->
			<div id="page-wrapper">
                ...
                while(rs.next()){ 
                     %>
                     <li><a href="Album.jsp?code=<%=rs.getString(2)%>"><%=rs.getString(3)%></a></li>
                     <%
                                         }
                          ...
                          <p>                
                            ...
                            <audio controls>
                                  ...
                                  <source src="media/ester.mp3" type="audio/mpeg">
                            </audio>
                            </p> 
                            <p>
                                <audio controls>
