<%-- 
    Document   : edit_song
    Created on : 30 Jul, 2020, 3:42:28 PM
    Author     : nicar
--%>
               ...
               String id=request.getParameter("id");
                ...
                ResultSet rs=st.executeQuery("select * from record where email='"+email+"'");  
                 if(rs.next()){
                   ...
                   ResultSet rs2=st1.executeQuery("select * from song where code='"+id+"'");    
		...
		<div id="chartdiv"></div>
				...
				<div class="chat-grids">
					...
					<div class="clearfix"></div>
                                                  ...
                                                  <!--record display-->
      <form method=post action="update_song.jsp?id=<%=id%>" >
                   <table border="1">
                         <thead>
                            <tr>
                              <th>sn </th>
                     ...
                     %>
                         ...
                         <tr>
                             ...
                             <td><%=rs2.getString(2)%></td>
                              <td>
                                  <input type='text' name='song_name' value="<%=rs2.getString(3)%>" required>
                              </td>
                              <td>
