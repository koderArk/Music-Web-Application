<%-- 
    Document   : show_song
    Created on : 25 Jul, 2020, 7:12:31 PM
    Author     : nicar
--%>
		...
		<div id="chartdiv"></div>
				...
				<div class="chat-grids">
                   ...
                   <table border="1">
                         ...
                         <tbody>
               <%     ResultSet rs2=st1.executeQuery("select * from song where album_code='"+id+"' AND status=1");  
                 while(rs2.next()){
                           String song_code=rs2.getString(2);                     
                     %>
                         ...
                         <tr>
                             ...
                             <td><%=song_code%></td>
                              ...
                              <td><a href='edit_song.jsp?id=<%=song_code%>'>Edit</a></td>
                              <td><a href='delete_song.jsp?id=<%=song_code%>'> Delete</a></td>
                ...
                <%
                 ...
                 <tr>
                     <td>
                         <a href='insert_song.jsp?id=<%=id%>'> insert new song</a>
                     </td>    
                   </tr>
                         </tbody>
                     </table>             
