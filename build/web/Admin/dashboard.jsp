<%-- 
    Document   : inbox
    Created on : 6 Mar, 2020, 5:25:36 PM
    Author     : nicar
--%>
        ...
        if(email!=null&&session.getAttribute(email)!=null){
           try{
                ...
                ResultSet rs=st.executeQuery("select * from record where email='"+email+"'");
                 ...
                 if(rs.next()){
                  ResultSet rs2=st.executeQuery("select * from category where status='"+1+"'");     
                                ...
                                while(rs2.next()){
                                    %>
                                            ...
                                            <td><%=rs2.getInt(1)%></td>&nbsp;
                                             <td><%=rs2.getString(2)%></td>&nbsp;
                                              <td><%=rs2.getString(3)%></td>&nbsp;
                                               <td><%=rs2.getInt(4)%></td>&nbsp;
                                               <td><a href="edit.jsp?code=<%=rs2.getString(2)%>">Edit</a></td>
                                               <td><a href="delete.jsp?code=<%=rs2.getString(2)%>">Delete</a></td>
                                        </tr>
                                        ...
                                        <div class="album_details">
                                            <li>
                                            <a href="album.jsp">Insert Album Title</a>
                                            </li>
                                            <li>
                                            <a href="show_album.jsp">Show Album List</a>
                                            </li>
                                            <li>
                                                <a href="show_song.jsp">Show Songs List</a>
                                            </li>
                                        </div>
