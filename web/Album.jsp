<%-- 
    Document   : Album
    Created on : Mar 30, 2020, 8:17:54 PM
    Author     : Tacom
--%>
...
<%
           ...
           try{  
               ...
               ResultSet rs=st.executeQuery("select * from category where code='"+category_code+"'");  
                 if(rs.next()){
		...
		<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="inner-content">
					...
					<!--//pop-up-box -->
<%	 
ResultSet rs1=st.executeQuery("select * from album where category_name='"+category_name+"'");	
%>			
						<div class="browse">
								<div class="tittle-head two">
									<h3 class="tittle"><%=category_name%>s <span class="new">New</span></h3>
...
<%              String code="";
                ...
                %>
								...
								<div class="col-md-3 browse-grid">
									 <a  href="Song.jsp?code=<%=rs1.getString(2)%>"><img src="album/<%=rs1.getString(2)%>.jpg" title="allbum-name"></a>
									 <a  href="Song.jsp?code=<%=rs1.getString(2)%>"><i class="glyphicon glyphicon-play-circle"></i></a>
									<a class="sing" href="Song.jsp?code=<%=rs1.getString(2)%>"><%=rs1.getString(3)%></a>
								</div>
<%	
                }
%>					
