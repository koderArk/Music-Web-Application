<%-- 
    Document   : show_album
    Created on : 23 Jul, 2020, 3:02:13 PM
    Author     : nicar
--%>
				...
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right dev-page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar" id="cbp-spmenu-s1">
					<div class="scrollbar scrollbar1">
						<ul class="nav" id="side-menu">
							...
							<li>
								<a href="album.jsp"><i class="fa fa-cogs nav_icon"></i>Add Album <span class="fa arrow"></span></a>
								
								<!-- /nav-second-level -->
							</li>
							<li>
								<a href="display_album.jsp"><i class="fa fa-book nav_icon"></i>All Albums <span class="fa arrow"></span></a>
		...
		<div id="chartdiv"></div>
				...
				<div class="chat-grids">
                   ...
                   <table border="1">
                         ...
                         <tbody>
               <%     ResultSet rs2=st1.executeQuery("select * from album where status=1");  
                 while(rs2.next()){
                           String album_code=rs2.getString(2);                     
                     %>
                         ...
                         <tr>
                             <td><%=rs2.getInt(1)%></td>
                             <td><%=album_code%></td>
                              <td><a href='display_song.jsp?id=<%=album_code%>'><%=rs2.getString(3)%></a></td>
                              <td><%=rs2.getString(4)%></td>
                              <td><%=rs2.getString(5)%></td>
                              <td><a href='edit_album.jsp?id=<%=album_code%>'>Edit</a></td>
                              <td><a href='delete_album.jsp?id=<%=album_code%>'> Delete</a></td>
...
<%
        ...
        int status=Integer.parseInt(request.getParameter("status"));
          int sn=0;
            ...
            ResultSet rs1=st1.executeQuery("select MAX(sn) from songs" );
           if(rs1.next()){
               sn=rs1.getInt(1);
           }
           sn=sn+1;
           code=code+"_"+sn; 
           st1.execute("insert into songs values("+sn+",'"+code+"','"+category_name+"',"+status+")");
