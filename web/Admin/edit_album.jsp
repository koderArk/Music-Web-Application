<%-- 
    Document   : edit_album
    Created on : 23 Jul, 2020, 3:41:16 PM
    Author     : nicar
--%>
               ...
               String id=request.getParameter("id");
                ...
                ResultSet rs=st.executeQuery("select * from record where email='"+email+"'");  
                 if(rs.next()){
                   ...
                   ResultSet rs2=st1.executeQuery("select * from album where code='"+id+"'");    
		...
		<div id="chartdiv"></div>
				...
				<div class="chat-grids">
					...
					<div class="clearfix"></div>
                                                  ...
                                                  <!--record display-->
      <form method=post action="update_album.jsp?id=<%=id%>" >
                   <table border="1">
                         <thead>
                            <tr>
                              <th>sn </th>
                     ...
                     %>
                         ...
                         <tr>
                             ...
                             <td><%=rs2.getString(2)%></td>
                              <td>
                                  <input type='text' name='title' value="<%=rs2.getString(3)%>" required>
                              </td>
                              <td>
                                  <input type='text' name='description' value="<%=rs2.getString(4)%>" required>
                              </td>
                              <td>
                                  <input type='text' name='category_name' value="<%=rs2.getString(5)%>" required>
                              </td>
                         </tr>
