<%-- 
    Document   : edit
    Created on : 12 Mar, 2020, 10:47:20 PM
    Author     : nicar
--%>
					...
					<div class="photoday-section">
						...
						<div class="col-md-4 photoday-grid">
							...
							<div class="clearfix"></div>
                             ...
                             <div>
                                 <form method=post action="update.jsp?code=<%=code%>">
                                    <table>
                                        <thead>
                                        <tr>
                                            <th>sn</th>&nbsp;
                            ...
                            <%
                                if(rs2.next()){
                                    %>
                                        ...
                                        <tr>
                                            <td><input type='number' name='user' value="<%=rs2.getInt(1)%>" required></td>&nbsp;
                                            <%-- <td><input type='text' name='code' value="<%=rs2.getString(2)%>" required></td>&nbsp;--%>
                                              <td><input type='text' name='category_name' value="<%=rs2.getString(3)%>" required></td>&nbsp;
                                               <td><input type='number' name='status' value="<%=rs2.getString(4)%>" required></td>
