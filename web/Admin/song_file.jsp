<%-- 
    Document   : song_file
    Created on : 25 Jul, 2020, 5:46:15 PM
    Author     : nicar
--%>
...
<body class="cbp-spmenu-push">
	...
	<input type="button" id="addPanelButton" onclick="addPanel()" value="add panel">
		...
		<div id="chartdiv"></div>
			...
			<!--//form-->
     <br><form method="post" ACTION="song_FileUploadProcess.jsp?id=<%=code%>" name="uploadForm" ENCTYPE='multipart/form-data' >
	  	   <div class="form-grid1">
								<h4> Form</h4>
								<div class="bottom-form">
									<div class="col-md-3 grid-form">
										<h5>Upload Song File:</h5>
									</div>
